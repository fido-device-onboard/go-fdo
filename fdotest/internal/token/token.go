...
var _ cbor.StreamMarshaler = (*keyExchange)(nil)
var _ cbor.StreamUnmarshaler = (*keyExchange)(nil)
...
func (x keyExchange) MarshalCBORStream(w io.Writer, o cbor.EncoderOptions, flattened int) error {
	...
	if flattened != 2 {
		return fmt.Errorf("keyExchange must be used with CBOR flat2 option")
	}
